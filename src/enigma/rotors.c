...
// Notches: Q
const enigma_rotor_t enigma_rotor_I = {
    .name = "I",
...
// Notches: E
const enigma_rotor_t enigma_rotor_II = {
    .name = "II",
...
// Notches: V
const enigma_rotor_t enigma_rotor_III = {
    .name = "III",
...
// Notches: ZM
const enigma_rotor_t enigma_rotor_VII = {
    .name = "VII",
...
// Notches: ZM
const enigma_rotor_t enigma_rotor_VIII = {
    .name = "VIII",
...
const enigma_rotor_t* enigma_rotors[] = {
    &enigma_rotor_I,
    &enigma_rotor_II,
    &enigma_rotor_III,
    &enigma_rotor_IV,
