...
int enigma_load_rotor_config(enigma_t*, const char*);
int enigma_load_rotor_positions(enigma_t*, const char*);

/* File I/O */
int enigma_load_custom_rotor(enigma_rotor_t*, const char*);
int enigma_load_custom_reflector(enigma_reflector_t*, const char*);
enigma_ngram_list_t* enigma_load_ngrams(const char*);
int enigma_load_config(enigma_t*, const char*);
int enigma_save_config(enigma_t*, char*);
