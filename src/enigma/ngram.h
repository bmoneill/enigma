...
float enigma_bigram_score(const enigma_crack_config_t*, const char*);
float enigma_trigram_score(const enigma_crack_config_t*, const char*);
float enigma_quadgram_score(const enigma_crack_config_t*, const char*);
